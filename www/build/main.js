...
var JugadoresAddPage = /** @class */ (function () {
    function JugadoresAddPage(navCtrl, navParams, _jugadoresProvider) {
        ...
        this.addJugadorForm = new __WEBPACK_IMPORTED_MODULE_2__angular_forms__["a" /* FormBuilder */]().group({
            ...
            elo: ['', __WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].required])],
    ...
    JugadoresAddPage.prototype.addJugador = function () {
        var jugador = new __WEBPACK_IMPORTED_MODULE_4__models_jugador_model__["a" /* Jugador */](this.addJugadorForm.controls['id'].value, this.addJugadorForm.controls['nombre'].value, this.addJugadorForm.controls['apellidos'].value, this.addJugadorForm.controls['elo'].value, this.addJugadorForm.controls['telefono'].value);
...
var Jugador = /** @class */ (function () {
    function Jugador(cod, nombre, apellidos, telefono, elo, partidas, ganadas, empatadas, perdidas, pc, pf, puntos) {
        if (elo === void 0) { elo = 0; }
